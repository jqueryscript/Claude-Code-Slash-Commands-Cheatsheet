...
| `/config` | Open settings, including editor mode and workflow keyword trigger settings | Public |
| `/doctor` | Run environment diagnostics and show recent update status | Public |
| `/effort [low\|medium\|high\|xhigh\|max\|auto]` | Set reasoning effort; no-arg `/effort` opens an interactive slider | Public |
...
- The old `CLAUDE_CODE_OPUS_4_6_FAST_MODE_OVERRIDE` path is deprecated and scheduled for removal on June 1, 2026.
